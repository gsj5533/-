...
def job(useid,password):
    ...
    if is_workday(nowTime):
        ...
        #driver.find_element_by_id('login').send_keys('guojd14')
        #driver.find_element_by_id('password').send_keys('gjdpku@0306')
...
def myRandomTime():
    ...
    print(mydelay)
    time.sleep(mydelay)
    job('gaosj24','Gaosj136!#^')
   #job('guojd14','gjdpku@0306')
    #job()
    #job_gaosj()
...
def myRandomTime1():
    ...
    print(mydelay)
    time.sleep(mydelay)
    job1('gaosj24','Gaosj136!#^')
    #job1('guojd14','gjdpku@0306')
